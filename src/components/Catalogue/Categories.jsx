        ...
        <Transition.Root show={mobileFiltersOpen} as={Fragment}>
          ...
          >
            ...
            <div className="fixed inset-0 z-40 flex">
              ...
              >
                <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col bg-white dark:bg-neutral overflow-y-auto py-4 pb-12 shadow-xl">
          ...
          <div className="flex items-baseline justify-between border-b pb-6 pt-12">
            ...
            <div className="flex items-center">
              <Menu as="div" className="relative inline-block text-left">
                <div>
                  <Menu.Button className="group inline-flex justify-center text-base font-medium  group-hover:text-blue-400">
                    Sort
                    <FontAwesomeIcon
                      icon={faChevronDown}
                      className="-mr-1 ml-1 h-5 w-5 flex-shrink-0  group-hover:text-blue-400"
                      aria-hidden="true"
                    />
                  </Menu.Button>
                </div>
